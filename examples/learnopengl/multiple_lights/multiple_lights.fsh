...
/* Spot Light */
uniform point4<World> spotLightPosition;
uniform vec3<World> spotLightDirection;
...
void main()
{
    ...
    /* Directional Light */
    {
        vec3<World> lightDir = normalize(-dirLightDirection);
    ...
    /* Point Light */
    {
        vec3<World> lightDir = normalize(pointLightPosition.xyz - FragPos.xyz);
    ...
    /* Spot Light */
    {
        vec3<World> lightDir = normalize(spotLightPosition.xyz - FragPos.xyz);
